...
def main():
    ...
    while True:
        ...
        if choice == '1':
            entry_time = input("Enter entry time (e.g., 09:30 AM): ").strip()
            ...
            entry_time = input("Enter entry time to delete (e.g., 09:30 AM): ").strip()
            ...
            entry_time = input("Enter entry time to search (e.g., 09:30 AM): ").strip()
